 ...
 */
function dpbc_nexus_html_head_alter(&$head_elements) {
 ...
 */
function dpbc_nexus_breadcrumb($variables) {
 ...
 */
function dpbc_nexus_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
function dpbc_nexus_preprocess_node(&$variables) {
  $node = $variables['node'];
...
function dpbc_nexus_page_alter($page) {
